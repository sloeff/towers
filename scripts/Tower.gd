...
func _draw() -> void:
	...
	draw_rect(Rect2(-11.0, -34.0, 22.0, 34.0), color.darkened(0.25))
	draw_rect(Rect2(-11.0, -34.0, 22.0, 34.0), color.darkened(0.7), false, 1.5)
	draw_circle(Vector2(0.0, -40.0), 8.0, color)
